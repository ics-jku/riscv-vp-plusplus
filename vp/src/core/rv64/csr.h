...
constexpr uint64_t MSTATUS_READ_MASK = 0b1000000000000000000000000000111100000000011111111111111110111011;
constexpr uint64_t SSTATUS_WRITE_MASK = 0b1000000000000000000000000000000000000000000011011110011100110011;
constexpr uint64_t SSTATUS_READ_MASK = 0b1000000000000000000000000000001100000000000011011110011100110011;
