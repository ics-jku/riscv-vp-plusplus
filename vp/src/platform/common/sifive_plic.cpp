...
SIFIVE_PLIC::SIFIVE_PLIC(sc_core::sc_module_name, bool fu540_mode, unsigned harts, unsigned numirq)
	...
	VPPP_PROPERTY_GET("SIFIVE_PLIC." + name(), "clock_cycle_period", sc_core::sc_time, prop_clock_cycle_period);
	VPPP_PROPERTY_GET("SIFIVE_PLIC." + name(), "access_clock_cycles", uint64_t, prop_access_clock_cycles);
	VPPP_PROPERTY_GET("SIFIVE_PLIC." + name(), "irq_trigger_clock_cycles", uint64_t, prop_irq_trigger_clock_cycles);
